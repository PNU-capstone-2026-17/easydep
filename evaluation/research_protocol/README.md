...
이 디렉터리는 확인적 연구의 경계다. 과거 DepKB 주장과 Native v1 인벤토리는 이 프로토콜로
재측정되기 전까지 탐색 자료로만 취급한다.
