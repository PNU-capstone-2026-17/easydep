"""agent-sdk 패키지의 절대 임포트를 새 배치(app/cloudkb/)로 옮긴다.
...
정규식으로 쓸면 이것들까지 `app.cloudkb.costkb`가 되어 출처 표시가 깨지고
...
사용:
    ...
    python scripts/rewrite_kb_imports.py <경로> --prefix app.cloudkb
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--prefix", default="app.cloudkb", help="새 임포트 접두 (기본: app.cloudkb)")
