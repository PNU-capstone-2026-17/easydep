...
정의와 근거는 `app/cloudkb/depkb`에 있다(3사 실측 주장과 그 소비 절차).
...
from app.cloudkb.depkb.check import Report, check
from app.cloudkb.depkb.closure import closure
from app.cloudkb.depkb.infra_intent import InfraIntent, build
from app.cloudkb.depkb.translate import Translation, translate
from app.cloudkb.depkb.views import design_view, provision_view
