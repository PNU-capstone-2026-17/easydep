...
사용 예:
  python -m app.cli "Users can log in with email and password." "Respond within 2s."
  python -m app.cli --file reqs.txt
  echo "I want to build a shop" | python -m app.cli        # stdin(파이프)
  python -m app.cli                                        # 대화형 입력
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.interactive:
        ...
        from app.agent.graph import rebuild_graph
        rebuild_graph()
