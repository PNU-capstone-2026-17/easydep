...
사용:
  ...
  python -m app.requirements.apply_feedback artifacts/evaluations/requirements/run_2026..._abcd "UC3 명세에 결제 실패 확장을 추가해줘"
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("run_dir", help="피드백을 적용할 기존 requirements/run_*/ 디렉토리")
