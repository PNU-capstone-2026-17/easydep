"""결함을 **낸 단계로 되돌릴지** 정한다 — 파이프라인에 되돌아가기를 주는 판단 층.
...
def _gave_up(state: dict, owner: str) -> bool:
...
def supervise_for(*allowed_groups: str) -> Callable[[dict], dict]:
    ...
    def supervise(state: dict) -> dict:
        ...
        if decision.action == ADVANCE:
            ...
            return {"redo_route": "advance", "stage_feedback": {}}
