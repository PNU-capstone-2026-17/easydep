...
from app.core.cloudkb.kbcommon.fetch import describe_source_set, fetch_cached, list_github_tree
from app.core.cloudkb.kbcommon.invariants import Invariant, Violation, announce
from app.core.cloudkb.kbcommon.sources import SOURCES
from app.core.cloudkb.patternkb.dataset import schema
...
def build(output: Path, *, refresh: bool = False) -> dict:
    ...
    from app.core.cloudkb.patternkb.parsers import gcp_framework
