"""시연 — 지식베이스가 **어떻게 답하는지**를 실물로 보여 준다.
    ...
    python -m app.core.cloudkb.tools.demo            # 전부, 한 번에
    python -m app.core.cloudkb.tools.demo --pause    # 발표용: 한 단계씩 Enter로 넘김
    python -m app.core.cloudkb.tools.demo --step 4   # 하나만
    python -m app.core.cloudkb.tools.demo --list     # 목차
