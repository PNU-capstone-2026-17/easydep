"""cb-tumblebug 미러 **전수 인벤토리** — 무엇이 들어 있고 우리가 무엇을 안 쓰는가.
    ...
    python -m app.core.cloudkb.tools.tumblebug_inventory --out report/…/inventory.json
...
from app.core.cloudkb.kbcommon.tumblebug_dump import fetch_dump, iter_table_rows
...
def inventory_details(rows_iter, *, cap: int) -> dict:
    ...
    from app.core.cloudkb.perfkb.parsers.details import parse_details
