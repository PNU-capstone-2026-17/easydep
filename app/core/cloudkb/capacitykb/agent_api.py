...
from app.core.cloudkb.capacitykb._text import _plural, _recreating
from app.core.cloudkb.capacitykb.model import CapacitySet
from app.core.cloudkb.capacitykb.query import (
    _cond_text,
    brief,
    check_value,
    find_quota,
...
from app.core.cloudkb.kbcommon.display import backend_caveat, display, evidence_name
...
def secrets(
    ...
    """
    from app.core.cloudkb.capacitykb.query import secret_properties
...
# --------------------------------------------------------------------------
from app.core.cloudkb.capacitykb._aws_endpoints import (  # noqa: E402, F401
    ENDPOINTS_FILE,
    where_available,
)
