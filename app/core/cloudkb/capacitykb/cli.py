...
def _cmd_audit(args: argparse.Namespace) -> int:
    ...
    """
    from app.core.cloudkb.capacitykb.parsers.cfn import DEFAULT_ZIP_URL, _scalar_type, iter_schemas
    from app.core.cloudkb.capacitykb.prose import extract_ranges
