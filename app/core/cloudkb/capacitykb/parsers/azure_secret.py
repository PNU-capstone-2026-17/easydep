...
from app.core.cloudkb.capacitykb.parsers.azure_mutability import _latest_stable, arm_type
...
from app.core.cloudkb.kbcommon.type_ids import AzureTypeIndex
...
def build(output: Path, *, refresh: bool = False) -> CapacitySet:
    from app.core.cloudkb.capacitykb.parsers.azure import _fetch_relative
