...
from app.core.cloudkb.capacitykb.prose import extract_default, extract_enum, extract_ranges
from app.core.cloudkb.kbcommon.fetch import describe_source, fetch_cached
