...
~~k8s·관리형 DB는 다음 수직 절단면으로 미룬다 — 배제가 아니라 순서다.~~
**2026-08-01에 갈렸다**: k8s는 실측했고(k8sCluster·NodeGroup·Service·Pvc·Ingress),
**관리형 상품 서비스는 범위 밖으로 확정했다**(`OUT_OF_SCOPE`). "미룬다"와
"안 한다"를 계속 겸하면 범위가 영영 안 닫힌다.
