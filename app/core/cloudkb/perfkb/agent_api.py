...
잘못 경고하는 것보다 모른다고 하는 게 낫다 — 다른 cloudkb와 같은 원칙. 다만
...
from app.core.cloudkb.kbcommon.basis import needs_hedge
...
from app.core.cloudkb.perfkb.fields import COMPARE_FIELDS, FIELDS
...
def compare(
    ...
    그래서 축별 수치만 나열하고 판단은 맡긴다 — 근거가 부족하면 판정을 보류한다.
