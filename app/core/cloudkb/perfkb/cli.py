...
from app.core.cloudkb.kbcommon.basis import describe
from app.core.cloudkb.perfkb.dataset import (
    BUILT_FILENAME,
    DEFAULT_OUTPUT_DIR,
    coverage,
    find,
...
from app.core.cloudkb.perfkb.fields import FIELDS
...
def _cmd_build(args: argparse.Namespace) -> int:
    ...
    from app.core.cloudkb.perfkb.parsers.build import build_dataset, format_audit
    ...
    if not args.no_hardware:
        from app.core.cloudkb.perfkb.parsers import hardware
    ...
    if not args.no_azure_sizes:
        ...
        from app.core.cloudkb.perfkb.parsers import azure_sizes
    ...
    from app.core.cloudkb.perfkb.parsers import azure_sizes as _az
    ...
    if not args.no_gcp_series:
        from app.core.cloudkb.kbcommon.fetch import describe_source_set
        from app.core.cloudkb.perfkb.parsers import gcp_series
