...
from app.core.cloudkb.costkb import agent_api
...
def _perf_hint(spec_name: str, provider: str | None) -> str:
    ...
    **축을 늘리는 것과 축에 닿게 하는 것은 다른 일이다** — 카탈로그 답만 주면
    ...
    """
    try:
        from app.core.cloudkb.costkb.dataset import find_by_name
        from app.core.cloudkb.perfkb.agent_api import hardware_facts, recommend_note
