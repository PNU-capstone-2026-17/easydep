...
def _cmd_suggest_mapping(args: argparse.Namespace) -> int:
    from app.core.cloudkb.graphkb.parsers.mapping import write_candidates
...
def _cmd_export(args: argparse.Namespace) -> int:
    ...
    if args.format == "graphml":
        from app.core.cloudkb.graphkb.export import write_graphml

        write_graphml(graph, output)
    elif args.format == "dot":
        from app.core.cloudkb.graphkb.export import write_dot

        write_dot(graph, output)
    else:
        from app.core.cloudkb.graphkb.export import write_cypher
...
def _cmd_load_neo4j(args: argparse.Namespace) -> int:
    ...
    from app.core.cloudkb.graphkb.neo4j_load import load_to_neo4j
