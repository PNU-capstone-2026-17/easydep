...
from app.core.cloudkb.perfkb.parsers.hardware import _cpu_fields, _gpu_fields, enrich
...
def test_profile_shows_hardware_separately() -> None:
    ...
    from app.core.cloudkb.perfkb.agent_api import _describe
...
def test_capacity_points_at_perf_for_compute_types() -> None:
    ...
    """
    from app.core.cloudkb.nim_agent.capacity_tools import _perf_pointer
...
def test_hardware_summary_counts_only_real_hardware() -> None:
    """하드웨어 근거가 있는 레코드만 센다."""
    from app.core.cloudkb.perfkb.agent_api import hardware_summary
...
def test_accelerator_filter_runs_before_sorting(tmp_path) -> None:
    ...
    from app.core.cloudkb.costkb.dataset import BUILT_FILENAME, _load_cached, filter_specs
...
def test_empty_result_says_the_accelerator_condition_is_on() -> None:
    ...
    from app.core.cloudkb.costkb import agent_api as cost
