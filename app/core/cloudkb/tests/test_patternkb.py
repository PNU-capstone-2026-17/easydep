...
from app.core.cloudkb.kbcommon.basis import INFERRED, basis_of, is_fact, needs_hedge
from app.core.cloudkb.kbcommon.display import evidence_name
from app.core.cloudkb.patternkb import dataset, query
from app.core.cloudkb.patternkb.agent_api import _MISSING, coverage_text, search_patterns
from app.core.cloudkb.patternkb.model import ADVISORY_NOTICE, EVIDENCE_ADVISORY
from app.core.cloudkb.patternkb.parsers.corpus import (
    SECTION_MINIMUMS,
    _fallback_title,
    _invariants,
    _parse_markdown,
...
def test_html_extraction_takes_article_body_only() -> None:
    ...
    from app.core.cloudkb.patternkb.parsers.gcp_framework import extract_text
...
def test_page_enumeration_excludes_printable_duplicates() -> None:
    from app.core.cloudkb.patternkb.parsers.gcp_framework import enumerate_pages
