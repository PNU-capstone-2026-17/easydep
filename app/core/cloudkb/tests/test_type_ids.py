...
from app.core.cloudkb.kbcommon.type_ids import make_type_id, read_azure_index
...
def test_both_parsers_agree_on_the_representative_spelling() -> None:
    ...
    """
    from app.core.cloudkb.capacitykb.parsers.azure import select_latest
    from app.core.cloudkb.graphkb.parsers.azure import parse_index
