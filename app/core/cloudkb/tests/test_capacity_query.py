...
from app.core.cloudkb.capacitykb.model import CapacitySet, Constraint, Quota
...
def test_out_of_scope_answer_does_not_claim_absence() -> None:
    ...
    """
    from app.core.cloudkb.capacitykb.agent_api import _nothing_found
...
def test_capacity_pointer_survives_broken_output(monkeypatch) -> None:
    ...
    from app.core.cloudkb.nim_agent import graph_tools
