...
from app.core.cloudkb.perfkb.dataset import _schema
from app.core.cloudkb.perfkb.parsers.build import build_dataset, format_audit, project_rows
from app.core.cloudkb.perfkb.parsers.project import project_row
from app.core.cloudkb.tests.test_perfkb_details import (
    EBS_INFO,
    NETWORK_INFO,
    PROCESSOR_INFO,
    VCPU_INFO,
