...
from app.core.cloudkb.capacitykb.parsers.cfnlint import parse_wheel, property_of
...
def test_conditions_of_ignores_target_markers() -> None:
    ...
    뜻 없는 조건이 생긴다.
    """
    from app.core.cloudkb.capacitykb.parsers.cfnlint import _conditions_of
...
def test_a_definite_mismatch_beats_an_unknown() -> None:
    ...
    """
    from app.core.cloudkb.capacitykb.model import Constraint
    from app.core.cloudkb.capacitykb.query import _condition_holds
...
def test_broken_regex_is_unknown_not_false() -> None:
    ...
    """
    from app.core.cloudkb.capacitykb.query import _one_condition
