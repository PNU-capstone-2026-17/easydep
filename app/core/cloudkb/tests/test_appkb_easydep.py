...
from app.core.cloudkb.appkb.easydep import (
    COMPONENT_ID,
    design_from_easydep,
    parse_classes,
    parse_er_entities,
...
def test_easydep_entrypoint_carries_verdicts_and_adapter_notes() -> None:
    ...
    from app.core.cloudkb.nim_agent.design_tools import deployment_answer_from_easydep
...
def test_puml_document_carries_evidence_as_comments() -> None:
    ...
    from app.core.cloudkb.nim_agent.design_tools import deployment_puml_from_easydep
...
def test_adapter_output_composes_into_a_plan() -> None:
    ...
    from app.core.cloudkb.appkb.verify import verify_diagram, verify_plan
...
def test_archetype_is_case_insensitive_but_never_invented() -> None:
    ...
    from app.core.cloudkb.appkb.easydep import archetype_values, parse_archetype
