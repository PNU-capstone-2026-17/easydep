...
from app.core.cloudkb.kbcommon.basis import INFERRED, STATED, basis_of
from app.core.cloudkb.perfkb.parsers.azure_sizes import enrich as azure_enrich
from app.core.cloudkb.perfkb.parsers.azure_sizes import parse_tables
from app.core.cloudkb.perfkb.parsers.gcp_series import enrich as gcp_enrich
from app.core.cloudkb.perfkb.parsers.gcp_series import parse_series_sql
...
def test_generation_flags_false_only_and_never_current_sizes() -> None:
    ...
    from app.core.cloudkb.perfkb.parsers.azure_sizes import _GENERATION_TABLE
...
def test_generation_enrich_marks_false_without_claiming_true() -> None:
    ...
    from app.core.cloudkb.perfkb.parsers.azure_sizes import enrich
