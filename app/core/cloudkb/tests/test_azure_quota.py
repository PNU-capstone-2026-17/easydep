...
from app.core.cloudkb.capacitykb.model import Quota
from app.core.cloudkb.capacitykb.parsers.azure_quota import parse_markdown
...
def test_default_reads_every_limits_doc() -> None:
    ...
    """
    from app.core.cloudkb.capacitykb.parsers.azure_quota import DEFAULT_INCLUDES
...
def test_coverage_states_that_only_azure_has_quotas(tmp_path) -> None:
    ...
    """
    from app.core.cloudkb.capacitykb.model import CapacitySet, Quota
...
def test_empty_include_list_does_not_silently_read_nothing(tmp_path) -> None:
    ...
    """
    from app.core.cloudkb.capacitykb.parsers.azure_quota import build
