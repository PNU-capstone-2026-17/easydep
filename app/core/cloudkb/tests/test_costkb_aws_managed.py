...
from app.core.cloudkb.costkb.dataset import managed_axes, managed_built
from app.core.cloudkb.costkb.parsers.aws_managed import (
    AXIS_CAPACITY,
    AXIS_INSTANCE,
    AXIS_USAGE,
    RULES,
...
def test_aws_managed_is_never_committed() -> None:
    ...
    from app.core.cloudkb.kbcommon.artifact import BUNDLED_DIR
...
def test_aws_plan_without_local_build_points_at_the_build_command() -> None:
    ...
    from app.core.cloudkb.nim_agent.design_tools import _render_plan_text, compose
