...
from app.core.cloudkb.costkb import agent_api as cost_api
from app.core.cloudkb.perfkb import dataset as perf_dataset
...
def test_bridge_warns_on_known_burst_spec(perf_built) -> None:
    from app.core.cloudkb.nim_agent.cost_tools import _perf_annotate
...
def test_bridge_failopens_when_perfkb_absent(perf_absent) -> None:
    ...
    from app.core.cloudkb.nim_agent.cost_tools import _perf_annotate, _perf_footer
...
def test_footer_explains_silence_when_built(perf_built) -> None:
    from app.core.cloudkb.nim_agent.cost_tools import _perf_footer
