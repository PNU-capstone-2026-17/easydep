...
from app.core.cloudkb.bundlekb import dataset
from app.core.cloudkb.bundlekb.agent_api import describe_named_bundle, list_bundles, resource_bundle
from app.core.cloudkb.bundlekb.model import REQUIRED, Bundle, Companion, Member
from app.core.cloudkb.kbcommon.basis import OBSERVED, STATED, describe, is_fact, needs_hedge
...
def test_bare_vendor_type_resolves_to_the_prefixed_key() -> None:
    ...
    """
    from app.core.cloudkb.bundlekb.dataset import resolve_type_id
...
def test_unknown_type_is_still_reported_missing() -> None:
    ...
    from app.core.cloudkb.bundlekb.agent_api import resource_bundle
    from app.core.cloudkb.bundlekb.dataset import resolve_type_id
