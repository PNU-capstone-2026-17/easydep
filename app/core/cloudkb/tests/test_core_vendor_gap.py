...
from app.core.cloudkb.graphkb.agent_api import _practical_prerequisites, creation_order
...
def test_creation_order_includes_the_note(graph, tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("app.core.cloudkb.graphkb.agent_api.load_merged", lambda output_dir=None: graph)
