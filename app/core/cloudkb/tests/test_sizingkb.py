...
from app.core.cloudkb.sizingkb import dataset
...
from app.core.cloudkb.sizingkb.model import Rule, usable_ips
...
def test_reviewed_reserved_ips_all_carry_a_verification_pointer() -> None:
    ...
    from app.core.cloudkb.sizingkb.parsers.reviewed import build_rules
...
def test_ncp_reserved_count_matches_the_documented_arithmetic() -> None:
    ...
    from app.core.cloudkb.sizingkb.model import usable_ips
    from app.core.cloudkb.sizingkb.parsers.reviewed import build_rules
