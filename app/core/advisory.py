...
사실이 아니다"*라는 고지가 붙는다. 그 문자열과 근거 라벨은 `app/core/cloudkb/patternkb`가
...
한동안은 사본이었다. `app/requirements`가 `app/core/cloudkb` 없이 돌아야 한다는 규약
...
from app.core.cloudkb.patternkb import model as _patternkb
