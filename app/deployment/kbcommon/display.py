...
_EVIDENCE_NAMES = {
    ...
    "svcmap-cross-checked": "MS 비교표+diagrams 분류 교차 확인",
    "ms-learn-comparison": "Microsoft Learn 서비스 비교표",
    "mingrammer-taxonomy": "diagrams 라이브러리 분류",
    "svcmap-reviewed": "사람 검수 대응(독립 소스 없음)",
