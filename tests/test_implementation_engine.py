...
from app.implementation.engine.generation.orchestrator import (
    find_undefined_bce_types,
    load_job,
    plan_e2e_tasks,
)
from app.implementation.engine.agents.runtime import (
    EventJournal,
    break_configuration_cycles,
    select_repair_paths,
)
from app.implementation.engine.agents.workspace import (
    changed_files,
...
from app.implementation.engine.agents.provider import (
    openhands_compatibility,
    transient_provider_error,
    provider_retry_delay,
)
from app.implementation.engine.agents.verification.build import (
    production_placeholder_markers,
    read_gradle_test_failures,
    summarize_test_failure,
    verify_run_workspace,
)
from app.implementation.engine.agents.prompts.feedback import (
    render_verification_feedback,
    verification_failure_hints,
)
from app.implementation.engine.workflows.repair import (
...
from app.implementation.engine.workflows.completion import audit_run_completion
from app.implementation.engine.agents.verification.e2e import e2e_contract_violations
from app.implementation.engine.delivery.kubernetes import (
    infer_intent,
    render_deployment,
    validate_intent,
)
from app.implementation.engine.delivery.terraform import render_iac, validate_terraform
from app.implementation.engine.workflows.conformance import (
    SourceDesignConformanceError,
    capture_generated_contracts,
    restore_generated_contracts,
    verify_source_design_conformance,
)
from app.implementation.engine.domain.implementation_ir import (
    ApiOperationIR,
    ApiPortIR,
    ApiResponseIR,
...
from app.implementation.engine.workflows.coordinator import (
...
""",
    ...
    @patch("app.implementation.engine.delivery.terraform.validate_terraform", return_value={"status": "SUCCEEDED"})
    ...
    @patch("app.implementation.engine.delivery.terraform.shutil.which", return_value=None)
    ...
    @patch("app.implementation.engine.delivery.terraform.validate_terraform", return_value={"status": "FAILED", "errors": ["provider schema rejected configuration"]})
...
"""
    ...
    def test_agent_workspace_uses_short_path_and_creates_allowed_parents(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "app.implementation.engine.agents.workspace.tempfile.gettempdir",
    ...
    def test_final_verification_uses_ascii_short_workspace_and_writes_report(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                ...
                patch(
                    "app.implementation.engine.agents.verification.build.verify_agent_workspace",
    ...
    def test_agent_workspace_uses_sibling_when_previous_workspace_is_locked(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                ...
                patch(
                    "app.implementation.engine.agents.workspace.shutil.rmtree",
